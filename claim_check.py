...
_SOFT_CONNECTIVE = frozenset(
    {
        ...
        # More ordinary business / apology filler from live Generate drafts
        "estimate", "estimates", "estimated", "estimating",
        "updated", "update", "updates", "updating",
        "reevaluation", "reevaluate", "reevaluated", "evaluation", "evaluate",
        "granting", "granted", "improve", "improved", "improving", "improvement",
        "inconvenience", "inconveniences", "inconvenienced",
        "meet", "meets", "meeting", "met",
        "assured", "assure", "assures", "assuring",
        "expectations", "expectation", "expected", "expect",
        "latest", "materials", "material",
        "obligations", "obligation", "patience",
        "rest", "scheduled", "significant", "significantly",
        "understanding", "understand", "understood",
        "additionally", "therefore", "otherwise", "hereby",
        "order", "orders", "ordering",  # "order number CT-552" glue; real invents still via event/guests
        "quality", "effort", "efforts", "regard", "regards",
        "matter", "matters", "circumstance", "circumstances",
        "appreciate", "appreciated", "appreciation",
        "sincerely", "respectfully", "cordially",
        "notify", "notified", "notification",
        "advise", "advised", "advising",
        "requesting", "requested", "requests",
        "hope", "hoped", "hoping",
        "feel", "feels", "feeling", "felt",
        "seem", "seems", "seemed", "appear", "appeared",
        "remain", "remains", "remaining",
        "ensure", "ensures", "ensured", "ensuring",
        "reach", "reaches", "reached", "reaching",
        "working", "worked", "works",
        "diligently", "promptly", "immediately", "urgently",
        "possible", "possibly", "possibility",
        "available", "availability", "convenient", "convenience",
        "necessary", "necessity", "needed",
        "appropriate", "suitable", "relevant",
        "current", "currently", "present", "presently",
        "future", "previous", "prior", "recent", "recently",
        "original", "initially", "initial",
        "complete", "completed", "completely", "completion",
        "successful", "successfully", "success",
        "able", "unable", "enable", "enabled",
        "cause", "caused", "causing", "causes",
        "contain", "contains", "contained", "containing",
        "include", "includes", "included", "including",
        "regarding", "concerning", "respecting",
        "toward", "towards", "within", "without", "across",
        "upon", "onto", "into", "from", "over", "under",
    }
)
