...
echo "       https://chromewebstore.google.com/detail/begfbbjincimcjcimpfpkoilbhjphppn?utm_source=item-share-cb"
echo ""
echo "  Developers: Chrome → Load unpacked → $ROOT/extension"
echo "============================================"
